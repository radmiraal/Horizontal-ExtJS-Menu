...
Tx.TreeEventModel = function() {
    Tx.TreeEventModel.superclass.constructor.apply(this, arguments);
};

Ext.extend(Tx.TreeEventModel, Ext.tree.TreeEventModel, {
...
Ext.reg('Tx.TreeEventModel', Tx.TreeEventModel);