...
F3.TYPO3.UserInterface.RootlineMenu.EventModel = function() {
    F3.TYPO3.UserInterface.RootlineMenu.EventModel.superclass.constructor.apply(this, arguments);
};

Ext.extend(F3.TYPO3.UserInterface.RootlineMenu.EventModel, Ext.tree.TreeEventModel, {
    ...
    getNode : function(e){
        var t;
        if(t = e.getTarget('.f3-rootline-node-el', 10)){
    ...
    getNodeTarget : function(e){
        var t = e.getTarget('.f3-rootline-node-icon', 1);
        if(!t){
            t = e.getTarget('.f3-rootline-node-el', 6);
        }
        return t;
    },
    ...
    delegateOut : function(e, t){
        ...
        if(e.getTarget('.f3-rootline-ec-icon', 1)){
    ...
    delegateClick : function(e, t){
        if(this.beforeEvent(e)){
            ...
            }else if(e.getTarget('.f3-rootline-ec-icon', 1)){
    ...
    onIconOver : function(e, node){
        node.ui.addClass('f3-rootline-ec-over');
    },

    onIconOut : function(e, node){
        node.ui.removeClass('f3-rootline-ec-over');
    },
...
Ext.reg('F3.TYPO3.UserInterface.RootlineMenu.EventModel', F3.TYPO3.UserInterface.RootlineMenu.EventModel);